...
class RobotCarHandle():
    ...
    def __init__(self, flodername=None):
        ...
        if not flodername:
            ...
            self.photo_path = './recentphoto/{}/'.format(flodername)
        ...
        # 黄色小木块初始颜色阈值
        self.lower_yellow = np.array([15, 150, 70])
        ...
        if not flodername:
            ...
            self.cut_pic_path = './recentphoto/{}/Cut/'.format(flodername)
    ...
    def jiaduobao_confirm(self, quhao, order_number):
        Jiaduobao_Template_Image = ["./model/1231.png"]
        Yuzhi = [80]
...
if __name__ == "__main__":
    ...
    # print(vision.photo_path, vision.cut_pic_path)
    # vision.image_handle_fixed_value()
    # vision.return_first_result()
    print(vision.find_yangleduo([]))
    # vision.second_process(0)
    # print(vision.pencil_confirm('B', 5))
    # for i in range(7, 25):
